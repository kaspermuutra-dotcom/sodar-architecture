...
const DOCS: Record<string, { updated: string; final: boolean; sections: [string, string][] }> = {
  ...
  terms: {
    ...
    sections: [
      ...
      ["Payment", "Sodar is billed as a monthly plan with property credits, through Stripe. Pilot partners may be invoiced at a reduced rate."],

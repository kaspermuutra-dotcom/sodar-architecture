 ...
 * inline with a poster; tap toggles play/pause. Assembled from the Higgsfield
 * clips plus typographic cards (see MEDIA_PLAN.md).
 */
export function IntroVideo() {
  ...
  return (
    <section className="section-shell border-t border-border">
      ...
      >
        <video ref={ref} src="/media/intro.mp4" poster="/media/intro-poster.jpg" muted loop autoPlay playsInline preload="metadata" className="aspect-video w-full object-cover" />
